...
return [
    ...
    'containers' => [
        ...
        'synchronization' => [
            ...
            'status' => [
                ...
                'zip_send' => 'Zip :zip / :otalZip}} received by medAl-data',
            ],
        ],
        'settings' => [
            'general' => [
    ...
    'patient' => [
        ...
        'readable_birth_date' => [
            'days' => ':alue}} days old',
            'weeks' => ':alue}} weeks old',
            'months' => ':alue}} months old',
            'years' => ':alue}} years old',
        ],
    ],
    'medical_case' => [
        'comment' => 'Comment',
    ...
    'formulations' => [
        'drug' => [
            ...
            'Give :doseResultml of :liquidConcentrationmg/:doseFormml :medicationForm',
            ...
            'dose_indication' =>
            'Dose range (:dosagemg/kg) x weight (:patientWeightkg) = :totalmg',
        ],
    ...
    'reference_table' => [
        'more' => 'more than :umber}}',
        'less' => 'less than :umber}}',
        'between' => 'Between :umber_1}} and :umber_2}}',
    ],
    'validation' => [
