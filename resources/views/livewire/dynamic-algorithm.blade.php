        ...
        <div wire:key="{{ 'consultation-' . $substep_title }}">
          <div class="d-flex">
            <div class="d-flex justify-content-start">
              <button class="btn button-unisante m-1"
                wire:click="goToSubStep('consultation', '{{ $substep_title }}')">{{ $substep_title }}</button>
            </div>
          </div>
          @if ($substep_title === 'medical_history')
            ...
            <div class="d-flex justify-content-end">
              <button class="btn button-unisante m-1" wire:click="goToSubStep('consultation', 'physical_exam')">Physical
                exam</button>
            </div>
          @endif
